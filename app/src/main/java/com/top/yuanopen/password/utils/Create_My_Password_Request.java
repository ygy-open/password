...
public class Create_My_Password_Request  extends BaseRequest {

    private static final String Action = "http:106.14.182.157:8080/mypassword/roomServlet?action=create";
    ...
    private static final String RequestParamKey_Create_Time = "create_time";
  ...
  ;
    ...
    public String getUrl(CreatePasswordParam param) {
        return Action
                ...
                + "&" + RequestParamKey_Create_Time + "=" + param.create_time
