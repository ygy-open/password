...
public class password implements Serializable{
    ...
    private  String image_uri;//图片地址
    private  String  password;//密码内容，ssh加密
    private  String create_time;//创建时间
    private  String update_time;//更新时间
    private String question_1;//问题1
    private String answer_1;//问题1答案
    private String question_2;//问题1
    private String answer_2;//问题1答案
    private String question_3;//问题1
    private String answer_3;//问题1答案
